<?php
	...
	include_once("../../core/admin_services.php");
    ...
    if($_SERVER['REQUEST_METHOD']=="POST"){
		...
		$fPass=$_POST['facultypass'];
        $fCpass=$_POST['facultyCpass'];
		$fPhn=$_POST['facultyphnNo'].$_POST['facultyphnNo1'];
		// $type=2;
        
		$result=addNewFaculty($fType,$fName,$fEmail,$fPass,$fPhn);
		$results=addNewLog($fEmail,$fPass,$fType);
        if($result && $results){
			...
			<table border="0" width="100%">
				<tr height="7" bgcolor="#3d1f05">
					...
					<td width="40" height="40">
						...
						<ul id="ul">
							<li id="q"><a class="active" href="admin_home.php">Home</a></li>
				...
				<td>
                    ...
                    <tr>
                        ...
                        <tr> <!-- create a table row -->
                            <td align="right">Name:</td> <!-- set table data -->
                            <td><input type="text" name="facultyname" placeholder="Please enter your First name" /></td>
                        </tr>

                        <tr>
                            <td align="right">Email:</td>
                            <td><input type="text" name="facultyemail" placeholder="Please enter your email" /></td>
                        </tr>
                        <tr>
                            <td align="right">Password:</td>
                            <td><input type="password" name="facultypass" /></td>
                        </tr>
                        <tr>
                            <td align="right">Confirm Password:</td>
                            <td><input type="password" name="facultyCpass" /></td>
                        </tr>
                        <tr>
                            <td align="right">Phone no:</td>
                            <td><input type="text" name="facultyphnNo" value="+880" size="1" readonly />
                                <input type="text" name="facultyphnNo1" size="13">
                            </td>
                        </tr>
                        <tr>
                            <td></td>
