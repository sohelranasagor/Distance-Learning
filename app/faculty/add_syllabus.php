<?php
    ...
    if($_SERVER['REQUEST_METHOD']=="POST"){
        ...
        $courseMeetingLecture=$_POST['courseMeetingLecture'];
        $courseMeetingReaction=$_POST['courseMeetingReaction'];
        $prerequisites=$_POST['prerequisites'];
        $courseDes=$_POST['courseDes'];
        $assOrExams=$_POST['assOrExams'];

        $result1=addNewSyllabus($courseMeetingLecture,$courseMeetingReaction,$prerequisites,$courseDes,$assOrExams,$instructor,$courseid);
        if($result1)
        {
				...
				<td>
					<table border="0" width="100%" align="center">
                        <tr> <!-- create a table row -->
                            <td align="right">Course MeetingTime Lecture:</td> <!-- set table data -->
                            <td><input type="text" name="courseMeetingLecture" placeholder="" /></td>
                        </tr>
                        <tr> <!-- create a table row -->
                            <td align="right">Course MeetingTime Reaction:</td> <!-- set table data -->
                            <td><input type="text" name="courseMeetingReaction" placeholder="" /></td>
                        </tr>
                        <tr>
                            <td align="right">Prerequisites:</td>
                            <td><input type="text" name="prerequisites" /></td>
                        </tr>
                        <tr>
                            <td align="right">Course Description:</td>
                            <td><input type="text" name="courseDes" /></td>
                        </tr>
                        <tr>
                            <td align="right">Assignment/Exams:</td>
                            <td><input type="text" name="assOrExams" /></td>
                        </tr>
                        <tr>
                            <td></td>
