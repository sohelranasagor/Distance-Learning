<?php
	...
	function fillCourse()
	{
		$courseList=loadAllCourseById($_GET['id']);
    ...
    function fillCourseByDepartment()
	{
		$courseList=loadAllCourseById($_GET['id']);
		foreach($courseList as $course)
		{
			echo "<a href='course_detail.php?id=$course[courseId]'>$course[courseTitle]</a></br>";
		}
	}
			...
			<table border="0" width="100%">
				...
				<td>
					...
					<table border="2" align = "right" width="50%" height = "200">
						...
						<tr id='border'>
                        <td valign="top" id='border' height='200'> <?=fillCourseByDepartment();?></td>
						</tr>
					</table>
				</div>
				</td></br>
