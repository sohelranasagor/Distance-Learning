	...
	<body>
		<form>
			<table border="0" width="100%">
				<tr height="15%" bgcolor="#553819" border="0">
					<td width="20%"></td>
					<td valign="top"> <h2> <b> <font color="#ec9000">E-VARSITY</font><font color="white">OPENCOURSEWARE</font> </b> </h2>
						<td width="30%" valign="top" align="right">
							...
							<h4> <font color="white">Welcome, <?=$name?></font> </h4><a href="../../core/logout.php"><font color="white">Logout</font></a>&nbsp;&nbsp;
						</td>
					</td>
					<td width="20%"></td>
				</tr>
				...
				<tr height="7" bgcolor="#3d1f05">
					...
					<td width="40" height="40">
						...
						<ul id="ul">
								...
								<li id="q"><a href="user_profile.php">My Profile</a></li>
								<li id="q"><a href="user_change_password.php">Change Password</a></li>
								<li id="q"><a href="find_course.php">Find Course</a></li>
								<li id="q"><a href="faculty_info.php">Faculty's Profile</a></li>
								<li id="q"><a href="messages.php">Message</a></li>
						</ul>
					</td>
					<td width="20%"></td>
				</tr>
			...
			<table border="0" width="100%">
				...
				<td>
					<table border="0" width="100%">
						<tr width="100%" height="100%"><img src="../Logos/education.jpg"   width="800" height="500"></tr><br/><br/><br/><br/>
						<tr>Education is the process of facilitating learning, or the acquisition of knowledge, skills, values, beliefs, and habits. Educational methods include storytelling, discussion, teaching, training, and directed research.</tr><br/><br/><br/><br/><br/><br/><br/><br/>
					</table>
				</td>
				<td width="20%"></td>
			</table>
