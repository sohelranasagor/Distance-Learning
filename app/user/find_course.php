				...
				<tr height="7" bgcolor="#3d1f05">
					...
					<table border="0" width="100%">
						<tr>
							...
							<td valign="right">
								<input type="text" id="TB" placeholder="Search.." name="searchTB"/>
								<input type="submit" name="submit" value="Search" onclick="validation()"/>				
							</td>
							</tr>
					</table>
					<script>
