<?php
    ...
    $result1=loadCourseAssignments($_GET['id']);
?>

<html>
	<head>
		<title>Assignments:<?= $result['courseTitle'];?></title>
	</head>
    <style>
        table {
				...
				<td>
					...
					<table>
						<td width="50%" valign="top">
                            <a href="course_lectute_notes.php?id=<?=$result['courseId']?>">Syllabus</a></br>
                            ...
                            <th>Assignments</th>
                                <?php
                                   foreach($result1 as $course)
                                   {
                                       ...
                                       echo"
                                       <tr>
                                            <td><a href='../faculty/$course[assignmentPdf]'>".substr($course["assignmentPdf"],12)."</a></td>
                                        </tr>
                                       ";
                                   }
                                ?>
